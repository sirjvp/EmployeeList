...
@section('content')
    ...
    <a href="{{ route('company.create') }}" class="btn btn-primary" type="button" style="margin-top: 82px;font-family: ABeeZee, sans-serif;width: 173px;margin-left: -103px;height: 40px;">ADD COMPANY</a>
